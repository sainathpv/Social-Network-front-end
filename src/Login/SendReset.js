    ...
    if (this.state.questions) {
      ...
      fetch(
        'http://' +
          ...
          '/forgot_psw/forgot_psw_questions',
        options
      )
        .then(result => {
          return result.json();
      ...
      .then(result => {
        if (result === null) {
          ...
          document.getElementById('warning').textContent =
            'A Reset Password Email has been send!!';
        }
      });
  }
      ...
      return (
        <div>
          <div className='question m-auto'>
            <p className='question' id='reset_question1'>
          ...
          <div className='question m-auto'>
            <p className='question' id='reset_question2'>
          ...
          <div className='question m-auto'>
            <p id='reset_question3'>{this.state.question3}</p>
          </div>
          <div className='input m-auto  text-left'>
  ...
  render() {
    if (this.state.sendResetEmail) {
      return (
        <form
          id='SendResetEmail'
          className='m-auto border-round-small'
        ...
        >
          <div className='container'>
            ...
            <div className='submitBox m-auto d-flex space-between'>
              <button className='d-inline' type='submit'>
                Send Email
              </button>
              <p className='d-inline' onClick={this.changeForm.bind(this)}>
                <br />
                Can't access email?
              </p>
            </div>
