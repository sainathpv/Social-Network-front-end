...
export default class SignUpForm extends Component {
  ...
  handleSubmit(event) {
    ...
    if (
      document.getElementById('signup_pwd1').value ===
      ...
      fetch(
        ...
        .then(result => {
          if (result.status === 200) {
            ...
            result.json().then(nr => {
              document.getElementById('signup_warning').textContent =
                nr.message;
            });
            return null;
          }
      ...
      document.getElementById('signup_warning').textContent =
        'Your Re-Enter Password is not the same';
    }
  }
  ...
  render() {
    if (this.state.signup) {
      return (
        <form id='SignUpForm' onSubmit={this.handleSubmit}>
          ...
          <div className='input m-auto  text-left'>
            <label>
              {this.state.accountType === 'student' ? 'FULL NAME' : 'COMPANY'}
            </label>
            <input
              id='signup_name'
          ...
          <div className='submitBox d-flex space-between m-auto'>
            ...
            <p className='d-inline' onClick={this.swapForm}>
              <br />
              Have an account?
            </p>
          </div>
      ...
      return <QuestionForm QRimg={this.state.QRimg} />;
    } else {
      return <SignInForm />;
    }
  }
